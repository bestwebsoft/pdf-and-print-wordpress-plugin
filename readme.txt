...
* Select position of the buttons in content:
	...
	* Top & Bottom Right
	* Top & Bottom Left
* Add buttons to widget area [NEW]
* Add buttons via shortcode [NEW]
* Set button type [NEW]:
	* Image
	* Text
	* Image + Text
...
* Set custom margins for PDF document [NEW]:
	* Left
	* Right
	* Top
	* Bottom
...
> * Set custom top and bottom margins for running title [NEW]
